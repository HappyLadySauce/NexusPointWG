...
type User struct {
	...
	Username     string    `json:"username" gorm:"uniqueIndex;not null" validate:"required,min=3,max=32"`
	...
	Status       string    `json:"status" gorm:"not null" validate:"required,oneof=active inactive"`
